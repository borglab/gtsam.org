...
2. [Boost](http://www.boost.org/users/download/) $\geq$ version **1.43** *(install through Linux repositories or MacPorts)*
3. [CMake](http://www.cmake.org/cmake/resources/software.html) $\geq$ version **3.0**
