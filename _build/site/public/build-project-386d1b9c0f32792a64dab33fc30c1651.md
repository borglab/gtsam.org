...
1. GTSAM requires the following libraries to be installed on your system:
    a. **BOOST** version **1.43** or greater *(install through Linux repositories or MacPorts)*
    b. **Cmake** version **3.0** or higher
    c. Support for **XCode 4.3** command line tools on Mac requires **CMake 2.8.8** or higher
