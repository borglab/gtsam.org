...
Welcome to GTSAM! Please follow this guide to setup GTSAM on your device.
...
Then execute the commands below in the root directory for an out-of-source build. This will build the library and unit tests (to the default system install path), run all of the unit tests, and then install the library itself.
