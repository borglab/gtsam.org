...
1. GTSAM makes extensive use of debug assertions, and we highly recommend you work in **Debug mode** while developing *(which is not enabled by default)*. Likewise, it is imperative that you switch to release mode when running finished code and for timing.
