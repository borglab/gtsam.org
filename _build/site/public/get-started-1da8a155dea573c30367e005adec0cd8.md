...
2. [Boost](http://www.boost.org/users/download/) $\geq$ v**1.43** *(install through Linux repositories or MacPorts)*
3. [CMake](http://www.cmake.org/cmake/resources/software.html) $\geq$ v**3.0**
