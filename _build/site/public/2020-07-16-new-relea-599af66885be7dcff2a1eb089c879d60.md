...
<div style="display: flex; justify-content: center; gap: 20px; align-items: center; flex-wrap: wrap;">
  <figure style="text-align: center; max-width: 45%;">
    ...
    <figcaption>Chordal Convergence</figcaption>
  </figure>
  <figure style="text-align: center; max-width: 45%;">
    <img src="/_static/release_403/success_rates.png" style="width: 100%; height: auto;">
    <figcaption>Success Rates</figcaption>
  </figure>
</div>
...
:::{grid-item}
![Image 1](/_static/release_403/chordal_convergence.png)
:::

:::{grid-item}
![Image 2](/_static/release_403/success_rates.png)
:::
:::
