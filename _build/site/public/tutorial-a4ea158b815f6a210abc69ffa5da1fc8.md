...
```{figure} Assets/Images/tutorial/1_hmm.png
:label: Figure 1
...
```{figure} Assets/Images/tutorial/2_hmm-FG.png
:label: Figure 2
...
```{figure} Assets/Images/tutorial/3_FactorGraph.png
:label: Figure 3
...
```{figure} Assets/Images/tutorial/4_FactorGraph2.png
:label: Figure 4
...
(my-figure-fruit)=
![Odometry marginals](Assets/Images/tutorial/5_Odometry.png)
...
```{figure} Assets/Images/tutorial/6_FactorGraph3.png
:label: Figure 6
...
```{figure} Assets/Images/tutorial/7_example1.png
:width: 75%
:label: Figure 7
...
```{figure} Assets/Images/tutorial/8_w100-result.png
:width: 75%
:label: Figure 8
...
```{figure} Assets/Images/tutorial/9_sphere2500-result.png
:width: 75%
:label: Figure 9
...
```{figure} Assets/Images/tutorial/10_FactorGraph4.png
:width: 75%
:label: Figure 10
...
```{figure} Assets/Images/tutorial/11_example2.png
:width: 75%
:label: Figure 11
...
```{figure} Assets/Images/tutorial/12_littleRobot.png
:width: 75%
:label: Figure 12
...
```{figure} Assets/Images/tutorial/13_Victoria.png
:width: 75%
:label: Figure 13
...
```{figure} Assets/Images/tutorial/14_cube.png
:width: 75%
:label: Figure 14
...
```{figure} Assets/Images/tutorial/15_Beijing.png
:width: 75%
:label: Figure 15
