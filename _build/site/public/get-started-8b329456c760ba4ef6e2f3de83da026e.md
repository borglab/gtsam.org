...
:::{tip} Ubuntu Prerequisite Installation:
:class: dropdown
```bash
...
(Ubuntu: [installing using APT](https://software.intel.com/en-us/articles/installing-intel-free-libs-and-python-apt-repo))
:::
