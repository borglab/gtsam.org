...
2. [Boost](http://www.boost.org/users/download/), version $\geq$ **1.43** *(install through Linux repositories or MacPorts)*
3. [CMake](http://www.cmake.org/cmake/resources/software.html), version $\geq$ **3.0**
