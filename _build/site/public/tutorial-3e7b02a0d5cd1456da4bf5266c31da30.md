...
:::{localpics} /Tutorial/1_hmm.png
:label: Figure 1
:caption: An HMM, unrolled over three time-steps, represented by a Bayes net.
:::
...
:::{localpics} /Tutorial/2_hmm-FG.png
:label: Figure 2
:caption: An HMM with observed measurements, unrolled over time, represented as a factor graph.
:::
...
:::{localpics} /Tutorial/3_FactorGraph.png
:label: Figure 3
:caption: Factor graph for robot localization.
:::
...
:::{localpics} /Tutorial/4_FactorGraph2.png
:label: Figure 4
:caption: Robot localization factor graph with unary measurement factors at each time step.
:::
...
(my-figure-fruit)=
![Odometry marginals _static/Tutorial/5_Odometry.png)

![Localization Marginals _static/Tutorial/5_Localization.png)
...
:::{localpics} /Tutorial/6_FactorGraph3.png
:label: Figure 6
:caption: Factor graph for PoseSLAM.
:::
...
:::{localpics} /Tutorial/7_example1.png
:label: Figure 7
:caption: The result of running optimize on the factor graph in Figure 6.
:::
...
:::{localpics} /Tutorial/8_w100-result.png
:label: Figure 8
:caption: MATLAB plot of small Manhattan world example with 100 poses (due to Ed Olson). The initial estimate is shown in green. The optimized trajectory, with covariance ellipses, in blue.
:::
...
:::{localpics} /Tutorial/9_sphere2500-result.png
:label: Figure 9
:caption: 3D plot of sphere example (due to Michael Kaess). The very wrong initial estimate, derived from odometry, is shown in green. The optimized trajectory is shown red. Code below:
:::
...
:::{localpics} /Tutorial/10_FactorGraph4.png
:label: Figure 10
:caption: Factor graph for landmark-based SLAM
:::
...
:::{localpics} /Tutorial/11_example2.png
:label: Figure 11
:caption: The optimized result along with covariance ellipses for both poses (in green) and landmarks (in blue). Also shown are the trajectory (red) and landmark sightings (cyan).
:::
...
:::{localpics} /Tutorial/12_littleRobot.png
:label: Figure 12
:caption: A larger example with about 100 poses and 30 or so landmarks, as produced by `gtsam_examples/PlanarSLAMExample_graph.m`
:::
...
:::{localpics} /Tutorial/13_Victoria.png
:label: Figure 13
:caption: Small section of optimized trajectory and landmarks (trees detected in a laser range finder scan) from data recorded in Sydney's Victoria Park (dataset due to Jose Guivant, U. Sydney).
:::
...
:::{localpics} /Tutorial/14_cube.png
:label: Figure 14
:caption: An optimized “Structure from Motion” with 10 cameras arranged in a circle, observing the 8 vertices of a {math}`20 \times 20 \times 20` cube centered around the origin. The camera is rendered with color-coded axes, (RGB for XYZ) and the viewing direction is is along the positive Z-axis. Also shown are the 3D error covariance ellipses for both cameras and points.
:::
...
:::{localpics} /Tutorial/15_Beijing.png
:label: Figure 15
:caption: A map of Beijing, with a spanning tree shown in black, and the remaining loop-closing constraints shown in red. A spanning tree can be used as a `preconditioner` by GTSAM.
:::
