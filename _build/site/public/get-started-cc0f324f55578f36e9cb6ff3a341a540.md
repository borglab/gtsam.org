...
First, make sure to be on a compatible software configuration:

:::{important} Software Configurations:
```{csv-table}
...
Next, make sure the following libraries are installed on your system to use GTSAM:
