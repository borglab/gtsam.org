...
Welcome to GTSAM! Here is a guide to installing and using GTSAM for the first time.

# Prerequisites

First, make sure you are on a compatible configuration:
...
2. GTSAM requires the following libraries to be installed on your system:

   
   - [Boost](http://www.boost.org/users/download/) $\geq$ **1.43** *(install through Linux repositories or MacPorts)*
   - [CMake](http://www.cmake.org/cmake/resources/software.html) $\geq$ **3.0**
