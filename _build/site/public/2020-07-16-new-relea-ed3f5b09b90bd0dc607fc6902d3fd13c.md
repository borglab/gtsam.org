...
<div style="display: flex; justify-content: center; gap: 20px; align-items: flex-start; flex-wrap: wrap; max-width: 100%;">
  <figure style="width: 40%; text-align: center; margin: 0;">
    <img src="/_static/release_403/chordal_convergence.png" style="width: 100%; height: auto; max-width: 100%;">
    <figcaption style="font-size: 14px; color: gray;">Chordal Convergence</figcaption>
  </figure>
  <figure style="width: 40%; text-align: center; margin: 0;">
    <img src="/_static/release_403/success_rates.png" style="width: 100%; height: auto; max-width: 100%;">
    <figcaption style="font-size: 14px; color: gray;">Success Rates</figcaption>
  </figure>
</div>
...
<div style="display: flex; justify-content: center; gap: 20px; align-items: center; flex-wrap: wrap;">
  <figure style="text-align: center; max-width: 45%;">
    <img src="/_static/release_403/chordal_convergence.png" style="width: 100%; height: auto;">
    <figcaption>a) With Chordal Initialization</figcaption>
  </figure>
  <figure style="text-align: center; max-width: 45%;">
    <img src="/_static/release_403/success_rates.png" style="width: 100%; height: auto;">
    <figcaption>b) Without Chordal Initialization</figcaption>
  </figure>
</div>
